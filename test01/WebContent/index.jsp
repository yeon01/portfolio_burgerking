...
<body>
	<div id="header">
		...
		<div class="login_button">
			<a href="#"><img src="./image/login_y.png" alt="로그인"></a>
		</div>
	</div>
		...
		<ul>
			<li>
				<div class="login_title">
					<img src="./image/login_icon.png" alt="일반로그인">
					<p>일반 로그인</p>
				</div>
				<form method="post" action="loginAction.jsp" class="login_form">
					<input type="text" name="userID" placeholder="ID(Email)" maxlength="20"> 
					<input type="text" name="userPassword" placeholder="Password" maxlength="20"> <img
						src="./image/view.png" alt="비밀번호 보기 잠금 버튼">
					<div class="login_check">
						<input type="checkbox" id="id_save">
						<label for="id_save" class="check_label"></label>
						<label for="id_save" class="check_text">아이디저장</label>
					</div>
					<div class="login_check">	 
						<input type="checkbox" id="sign_up">
						<label for="sign_up" class="check_label"></label>
						<label for="sign_up" class="check_text">회원가입</label>
					</div>
					
					<div class="login_submit">
						<label for="login_submit" class="login_btn"><span>로그인</span><img src="./image/login.png" alt="로그인"></label>
						<input type="submit" value="로그인" id="login_submit">
					</div>
				</form>
					<div class="signUp_submit">
						<a href="join.jsp">
							<label for="signUp_submit" class="signUp_btn"><span>회원가입</span><img src="./image/join.png" alt="회원가입"></label>
			...
			<li><img src="./image/fast_login.png" alt="비회원 주문">
				<p>비회원 주문</p></li>
		</ul>
	</div>
